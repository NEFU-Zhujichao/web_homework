    ...
    <div class="container">
        <div class="col-md-12">
            ...
            <div class="content">
                <h3>李琰</h3>
                <div class="others">
                    <span>发布日期：2018-12-10&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span>来源：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span>点击量：1497</span>
                </div>
                <hr>
                <div class="container-introduce">
                    <div style="text-align: center"><a href="#"><img src="statics/liyan.jpg" alt=""></a></div>
                    <p>
                        李琰，讲师，主要研究方向：软件工程，遥感和林业信息。参与科研项目多项，参编教材1部，并发表部分相关论文。
                    </p>
                    <hr>
                    <p>上一条：<a href="${pageContext.request.contextPath}/teacher">王波</a></p>
                    <p>下一条：<a href="${pageContext.request.contextPath}/teacher">赵玉茗</a></p>
                </div>
