        ...
        <div class="students">
            ...
            <div id="four_flash">
                <div class="flashBg">
                    <ul class="mobile">
                        <li>
                            <img src="statics/luosiqing.png"/>
                            <dd>罗嗣卿</dd>
                            <p>罗嗣卿，硕士，副教授，硕士生导师。</p>
                            <a href="${pageContext.request.contextPath}/associateProfessor"></a>
                        </li>
                        <li>
                            <img src="statics/lili.jpg"/>
                            <dd>李莉</dd>
                            <p>李莉，博士，副教授软件工程主任，专业教工党支部书记，硕士生导师。</p>
                            <a href="${pageContext.request.contextPath}/associateProfessor"></a>
                        </li>
                        <li>
                            <img src="statics/liudan.jpg"/>
                            <dd>刘丹</dd>
                            <p>刘丹，副教授，工学博士，硕士生导师，软件工程专业副主任。</p>
                            <a href="${pageContext.request.contextPath}/associateProfessor"></a>
                        </li>
                        <li>
                            <img src="statics/zhangxiying.jpg"/>
                            <dd>张锡英</dd>
                            <p>张锡英， 副教授，硕士，硕士生导师。</p>
                            <a href="${pageContext.request.contextPath}/associateProfessor"></a>
                        </li>
                        <li>
                            <img src="statics/qiuzhaowen.jpg"/>
                            <dd>邱兆文</dd>
                            <p>邱兆文，博士，副教授，硕士生导师。美国卡内基梅隆大学访问学者。</p>
                            <a href="${pageContext.request.contextPath}/associateProfessor"></a>
                        </li>
                        <li>
                            <img src="statics/zhaoyuming.jpg"/>
                            <dd>赵玉茗</dd>
