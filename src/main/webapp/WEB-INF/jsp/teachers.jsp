        ...
        <div class="students">
            ...
            <div id="four_flash">
                <div class="flashBg">
                    <ul class="mobile">
                        <li>
                            <img src="statics/liyan.jpg"/>
                            <dd>李琰</dd>
                            <p>李琰，讲师，主要研究方向：软件工程，遥感和林业信息。</p>
                            <a href="${pageContext.request.contextPath}/teacher"></a>
                        </li>
                        <li>
                            <img src="statics/wangbo.jpg"/>
                            <dd>王波</dd>
                            <p>王波，讲师，硕士。主要研究方向：计算数学，软件开发。</p>
                            <a href="${pageContext.request.contextPath}/teacher"></a>
                        </li>
                        <li>
                            <img src="statics/shanying.png"/>
                            <dd>单颖</dd>
                            <p>单颖，博士，讲师，主要研究方向：软件工程，林业信息。</p>
                            <a href="${pageContext.request.contextPath}/teacher"></a>
                        </li>
                        <li>
                            <img src="statics/bianjilong.jpg"/>
                            <dd>边继龙</dd>
                            <p>边继龙，博士，讲师。主要研究方向：立体匹配、矢量地图压缩。</p>
                            <a href="${pageContext.request.contextPath}/teacher"></a>
                        </li>
                        <li>
                            <img src="statics/sunhailong.png"/>
                            <dd>孙海龙</dd>
                            <p>孙海龙，工学博士，讲师，计算机科学与技术专业党支部书记兼副主任。</p>
                            <a href="${pageContext.request.contextPath}/teacher"></a>
                        </li>
                        <li>
                            <img src="statics/mulixin.jpg"/>
                            <dd>穆丽新</dd>
                            <p>穆丽新，硕士，讲师，主要研究方向：计算机基础教育、计算机应用。</p>
                            <a href="${pageContext.request.contextPath}/teacher"></a>
                        </li>
                    </ul>
                </div>
